...
describe('rules links', () => {
	test('links every Core Rules version through its versioned route', () => {
		...
		expect(coreRulesLinks.document('unvalidated')).toBe('/reference/core-rules/unvalidated')
	...
	test('links every Tournament Rules version through its versioned route', () => {
		...
		expect(tournamentRulesLinks.document('unvalidated')).toBe('/reference/tournament-rules/unvalidated')
